...
| frontend/src/components/AcquireCard.jsx:124 | raw-button | `<button` |
| frontend/src/components/AcquireCard.jsx:135 | raw-button | `<button` |
| frontend/src/components/AcquireCard.jsx:149 | raw-button | `<button` |
| frontend/src/components/AcquireCard.jsx:160 | raw-button | `<button` |
| frontend/src/components/AcquireCard.jsx:174 | raw-button | `<button` |
