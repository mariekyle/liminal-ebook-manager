...
**Run date:** 2026-07-23 (date of last content change)
...
| Raw <button> outside components/ui/ | report-only | 99 | — (report-only) | ℹ️ counted |
...
| frontend/src/components/BookDetail.jsx:2067 | raw-button | `<button` |
| frontend/src/components/BookDetail.jsx:3015 | raw-button | `<button` |
| frontend/src/components/BookDetail.jsx:3514 | raw-button | `<button` |
