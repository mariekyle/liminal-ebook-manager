...
**Run date:** 2026-07-25 (date of last content change)
...
| frontend/src/components/BookDetail.jsx:1729 | chrome — mobile tab bar |
| frontend/src/components/BookDetail.jsx:1740 | chrome — mobile tab bar |
| frontend/src/components/BookDetail.jsx:1751 | chrome — mobile tab bar |
| frontend/src/components/BookDetail.jsx:1784 | chrome — priority popup trigger |
| frontend/src/components/BookDetail.jsx:2032 | ratified-bespoke (v0.60.0 status toggle) |
| frontend/src/components/BookDetail.jsx:2981 | ratified-bespoke (session form semantic actives) |
| frontend/src/components/BookDetail.jsx:3484 | format-picker row — option-shaped, below the element-children bar |
