...
| Sessions-canonical reading status | ✅ Backend half (B1): title status/dates/rating projected from sessions on every write (v0.59.0); frontend toggle (B2) next |
