...
Built over months of iterative development using Claude Projects for architecture and planning, and Cursor for implementation. Every feature designed, tested, and refined by hand on the device it's meant for.
